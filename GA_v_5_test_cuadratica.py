...
m = [15, 15, 15, 15, 15, 15] # PRECISIÓN 0.00015 cada variable
...
m_rate=[1./bits, 2./bits, 5./bits, 18./bits]
in_mutar=[5, 50, 200, 3000]  #Individuo a partir del cual queremos empezar a mutar
