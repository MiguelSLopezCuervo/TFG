...
GA v_5
    ...
    ALGORITMO COMPLETAMENTE DEFINITIVO.
    soluciona que si N_Keep es muy grande solo se reproducen los primeros, entonces se ahorra tiempo
...
#Parámetros del GA
n = 6 # Variables a optimizar
m = [35, 35, 35, 35, 35, 35] # PRECISIÓN 0.00015 cada variable
x_max = [5.12, 5.12, 5.12, 5.12, 5.12, 5.12]
x_min = [-5.12, -5.12, -5.12, -5.12, -5.12, -5.12]
N_pop = 10000
N_Keep= 200
N_Desc = N_pop-N_Keep
...
m_rate=[3./bits, 5./bits, 10./bits, 100./bits]
in_mutar=[10, 1000, 3000, 9500]  #Individuo a partir del cual queremos empezar a mutar
...
file_name = "mejores_individuos.txt"
...
with open(file_name, 'w') as file:
    for i in range(0, it):
        ...
        # Evaluar los costes
        for j in range(0, N_pop):
            costes[j] = Rastrigin(pop_variables[j])
